#!/usr/bin/env python3
"""Patch all Type 3 images on Ganesh Chaturthi post WP #30064."""
import base64
import json
import os
import re
...
def validate_content(content):
    ...
    rules = {
        ...
        "flatlay_inserted": "ganesh-flatlay-2026.webp" in content,
        "lifestyle_inserted": "ganesh-lifestyle-2026.webp" in content,
    }
...
def main():
    ...
    flatlay_target = '<!-- wp:heading -->\n<h2 class="wp-block-heading">Vinayagar Chaturthi Wishes &amp; Regional Greetings</h2>'
    ...
    if flatlay_target not in content_clean:
        flatlay_target_alt = '<h2 class="wp-block-heading">Vinayagar Chaturthi Wishes &amp; Regional Greetings</h2>'
    ...
    lifestyle_target = '<!-- wp:heading -->\n<h2 class="wp-block-heading">Ganesh Chaturthi Wishes for Wealth, Prosperity &amp; Success</h2>'
    ...
    if lifestyle_target not in content_clean:
        lifestyle_target_alt = '<h2 class="wp-block-heading">Ganesh Chaturthi Wishes for Wealth, Prosperity &amp; Success</h2>'
    ...
    product_media_file = ROOT / "output/Week1_Rank13_GaneshChaturthi_product_media.json"
    ...
    from publish_ganesh_article import build_faqs, TITLE, META_DESC, FOCUS_KW, YOAST_TITLE
    ...
    print("Saved local HTML file output/Week1_Rank13_GaneshChaturthi_article.html")

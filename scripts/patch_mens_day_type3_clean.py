...
PROMPTS = json.loads((ROOT / "output/Week1_Rank18_MensDay_type3_prompts.json").read_text())

SLOTS = {
    "hero": {
        "src": ROOT / "output/magnific_generated/mens-day-hero-2026.webp",
        "featured": True,
    },
    "flatlay": {
        "src": ROOT / "output/magnific_generated/mens-day-flatlay-2026.webp",
        "featured": False,
    },
    "lifestyle": {
        "src": ROOT / "output/magnific_generated/mens-day-lifestyle-2026.webp",
        "featured": False,
    },
}
...
def main():
    ...
    for slot, cfg in SLOTS.items():
        ...
        alt = PROMPTS["slots"][slot].get("alt", f"Men's Day 2026 {slot}")
    ...
    flatlay_targets = [
        '<h2 class="wp-block-heading">Happy Men&#x27;s Day Quotes &amp; International Men&#x27;s Day Quotes</h2>',
        '<h2 class="wp-block-heading">Happy Men\'s Day Quotes &amp; International Men\'s Day Quotes</h2>',
    ]
    lifestyle_targets = [
        '<h2 class="wp-block-heading">Men&#x27;s Day Captions for Instagram &amp; Status</h2>',
        '<h2 class="wp-block-heading">Men\'s Day Captions for Instagram &amp; Status</h2>',
    ]
    ...
    from optimize_mens_day_article import TITLE, META_DESC, build_faqs

    product_media = json.loads((ROOT / "output/Week1_Rank18_MensDay_product_media.json").read_text())
    ...
    (ROOT / "output/Week1_Rank18_MensDay_article.html").write_text(final_content)

#!/usr/bin/env python3
"""
DEPRECATED — Magnific API is retired for BlueStone Type 3.

Use Higgsfield MCP instead: docs/HIGGSFIELD_IMAGE_GENERATION.md

Generate Type 3 concept images via Magnific API (legacy only).

...
SLUG = "akshaya-tritiya-quotes-wishes-2027"

PROMPTS = json.loads(
    (ROOT / "output/Week1_Rank30_AkshayaQuotes_type3_prompts.json").read_text(encoding="utf-8")
)
POST_ID = PROMPTS.get("wp_post_id")

SLOTS = {
    "hero": {
        "src": ROOT / "output/magnific_generated/akshaya-tritiya-hero-2027.webp",
        "featured": True,
        "media_title": "akshaya tritiya quote 2027 Hero",
    },
    "flatlay": {
        "src": ROOT / "output/magnific_generated/akshaya-tritiya-flatlay-2027.webp",
        "featured": False,
        "media_title": "akshaya tritiya quote 2027 Flatlay",
    },
    "lifestyle": {
        "src": ROOT / "output/magnific_generated/akshaya-tritiya-lifestyle-2027.webp",
        "featured": False,
        "media_title": "akshaya tritiya quote 2027 Lifestyle",
    },
}
...
def main():
    if not POST_ID:
        raise SystemExit("Set wp_post_id in Week1_Rank30_AkshayaQuotes_type3_prompts.json first.")
    ...
    flatlay_target = '<h2 class="wp-block-heading">Akshaya Tritiya Quotes</h2>'
    ...
    lifestyle_target = '<h2 class="wp-block-heading">Akshaya Tritiya Captions for Instagram</h2>'
    ...
    from publish_akshaya_quotes_article import TITLE, META_DESC, build_faqs

    product_media = json.loads(
        (ROOT / "output/Week1_Rank30_AkshayaQuotes_product_media.json").read_text(encoding="utf-8")
    )
    ...
    (ROOT / "output/Week1_Rank30_AkshayaQuotes_article.html").write_text(final_content, encoding="utf-8")
    (ROOT / "output/Week1_Rank30_AkshayaQuotes_type3_media.json").write_text(

...
PROMPTS = json.loads((ROOT / "output/Week1_Rank17_RepublicDay_type3_prompts.json").read_text())

SLOTS = {
    "hero": {
        "src": ROOT / "output/magnific_generated/republic-day-hero-2027.webp",
        "featured": True,
    },
    "flatlay": {
        "src": ROOT / "output/magnific_generated/republic-day-flatlay-2027.webp",
        "featured": False,
    },
    "lifestyle": {
        "src": ROOT / "output/magnific_generated/republic-day-lifestyle-2027.webp",
        "featured": False,
    },
}
...
def main():
    ...
    for slot, cfg in SLOTS.items():
        ...
        alt = PROMPTS["slots"][slot].get("alt", f"Republic Day 2027 {slot}")
    ...
    # Match WP-encoded apostrophes if present
    flatlay_targets = [
        '<h2 class="wp-block-heading">Republic Day Quotes &amp; Quotations in English</h2>',
    ]
    lifestyle_targets = [
        '<h2 class="wp-block-heading">Republic Day Captions for Instagram &amp; WhatsApp Status</h2>',
    ]
    ...
    from optimize_republic_day_article import TITLE, META_DESC, build_faqs

    product_media = json.loads((ROOT / "output/Week1_Rank17_RepublicDay_product_media.json").read_text())
    ...
    (ROOT / "output/Week1_Rank17_RepublicDay_article.html").write_text(final_content)

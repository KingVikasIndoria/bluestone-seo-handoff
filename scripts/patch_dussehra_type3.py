#!/usr/bin/env python3
"""Patch all Type 3 images on Dussehra post WP #30041."""
import base64
import json
import os
import re
...
PROMPTS = json.loads((ROOT / "output/Week1_Rank11_DussehraWishes_type3_prompts.json").read_text())

SLOTS = {
    "hero": {
        "src": ROOT / "output/magnific_generated/dussehra-hero-2026.webp",
        "featured": True,
    },
    "flatlay": {
        "src": ROOT / "output/magnific_generated/dussehra-flatlay-2026.webp",
        "featured": False,
    },
    "lifestyle": {
        "src": ROOT / "output/magnific_generated/dussehra-lifestyle-2026.webp",
        "featured": False,
    },
}
...
def validate_content(content):
    ...
    rules = {
        ...
        "flatlay_inserted": "dussehra-flatlay-2026.webp" in content,
        "lifestyle_inserted": "dussehra-lifestyle-2026.webp" in content,
    }
...
def main():
    ...
    for slot, cfg in SLOTS.items():
        ...
        alt = PROMPTS["slots"][slot].get("alt", f"Dussehra 2026 {slot}")
    ...
    flatlay_target = '<!-- wp:heading -->\n<h2 class="wp-block-heading">Dussehra wishes in Hindi &amp; Regional Languages</h2>'
    ...
    if flatlay_target not in content_clean:
        flatlay_target_alt = '<h2 class="wp-block-heading">Dussehra wishes in Hindi &amp; Regional Languages</h2>'
    ...
    lifestyle_target = '<!-- wp:heading -->\n<h2 class="wp-block-heading">Dussehra Greetings for Colleagues &amp; Professional Contacts</h2>'
    ...
    if lifestyle_target not in content_clean:
        lifestyle_target_alt = '<h2 class="wp-block-heading">Dussehra Greetings for Colleagues &amp; Professional Contacts</h2>'
    ...
    product_media_file = ROOT / "output/Week1_Rank11_DussehraWishes_product_media.json"
    ...
    from publish_dussehra_article import build_faqs, TITLE, META_DESC, FOCUS_KW, YOAST_TITLE
    ...
    (ROOT / "output/Week1_Rank11_DussehraWishes_article.html").write_text(final_content)
    print("Saved local HTML file output/Week1_Rank11_DussehraWishes_article.html")
